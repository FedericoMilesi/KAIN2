...
void FX_DFacadeParticleSetup(struct _FX_PRIM* fxPrim, SVECTOR* center, short halveWidth, short halveHeight, long color, SVECTOR* vel, SVECTOR* accl, struct _FXTracker* fxTracker, int timeToLive) { // Matching 99.91%
	short _x1;
	short _y1;
	short _z1;
	_Position* _v0;
	...
	{
		fxPrim->duo.phys.xVel = NULL;
		fxPrim->duo.phys.yVel = NULL;
		fxPrim->duo.phys.zVel = NULL;
	}
	...
	{
		fxPrim->duo.phys.xAccl = NULL;
		fxPrim->duo.phys.yAccl = NULL;
		fxPrim->duo.phys.zAccl = NULL;
	}
...
void FX_SoulReaverWinding(struct _Instance *instance, struct _PrimPool *primPool, unsigned int **ot, MATRIX *wcTransform)
...
void FX_Spiral(struct _PrimPool* primPool, unsigned long** ot)//Matching - 65.16%
{
	...
	if ((unsigned int*)(poly + 65) < primPool->lastPrim)
	{
		...
		primPool->nextPrim = (unsigned int*)poly;

...
// autogenerated function stub: 
// int /*$ra*/ PHYSOBS_CheckObjectAxisAlignment(MATRIX *m0 /*$a0*/, MATRIX *m1 /*$s1*/, struct _SVector *axis /*$s0*/)
int PHYSOBS_CheckObjectAxisAlignment(MATRIX *m0, MATRIX *m1, struct _SVector *axis)

...
void G2EmulationSetInterpController_Vector(struct _Instance* instance, long segment, long type, struct _G2SVector3_Type* vec, int Frames, int Data) { // Matching 100%
	G2Anim_SetInterpController_Vector(&instance->anim, segment & 0xFF, type & 0xFF, vec, Frames * 0x640000 >> 0x10);
	G2Anim_SetControllerCallbackData(&instance->anim, segment & 0xFF, type & 0xFF, (void*)Data);
}
